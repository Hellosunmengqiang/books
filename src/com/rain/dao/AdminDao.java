...
public class AdminDao {
	 ...
	 */
	public boolean Login_verify(String username,String password) throws ClassNotFoundException{
	 ...
	 * @throws ClassNotFoundException 
	 */
	public void Register(String username, String password, String name, String email, String phone,int lend_num,int max_num) throws ClassNotFoundException {
		// TODO Auto-generated method stub
				...
				try {
					...
					//if(rs>0)System.out.println("ok2");
				} catch (SQLException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
	 ...
	 * @throws ClassNotFoundException 
	 */
	public AdminBean getAdminInfo(String username, String password) throws ClassNotFoundException {
		// TODO Auto-generated method stub
...
//			stm.setString(1,name);
	 ...
	 * @throws ClassNotFoundException 
	 */
	public ArrayList<AdminBean> get_ListInfo() throws ClassNotFoundException{
	 ...
	 * @throws ClassNotFoundException 
	 */
	public AdminBean get_AidInfo(int aid) throws ClassNotFoundException{
		AdminBean adminbean = new AdminBean();
		Connection conn = DBUtil.getConnectDb();
	 ...
	 * @throws ClassNotFoundException 
	 */
	public AdminBean get_AidInfo2(String aid) throws ClassNotFoundException{
		AdminBean adminbean = new AdminBean();
		Connection conn = DBUtil.getConnectDb();
		String sql = "select * from admin where aid="+aid;
		PreparedStatement stm = null;
	...
	public void updateUser(int aid, String username, String password, String name, String email, String phone,
			int lend_num, int max_num) throws ClassNotFoundException {
		// TODO Auto-generated method stub
		Connection conn = DBUtil.getConnectDb();
	 ...
	 * @throws ClassNotFoundException 
	 */
	public void deleteUser(int aid) throws ClassNotFoundException {
		// TODO Auto-generated method stub
				Connection conn = DBUtil.getConnectDb();
