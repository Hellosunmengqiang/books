...
public class BookDao {
	 ...
	 */
	public void addBook(String card, String name, String type, String autho, String press, int num) throws ClassNotFoundException {
	 ...
	 * @throws ClassNotFoundException 
	 */
	public ArrayList<BookBean> get_ListInfo() throws ClassNotFoundException{
	 ...
	 * @throws ClassNotFoundException 
	 */
	public ArrayList<HistoryBean> get_HistoryListInfo(int status,String aid) throws ClassNotFoundException{
	 ...
	 * @throws ClassNotFoundException 
	 */
	public ArrayList<HistoryBean> get_HistoryListInfo2(int status) throws ClassNotFoundException{
		ArrayList<HistoryBean> tag_Array = new ArrayList<HistoryBean>();
		Connection conn = DBUtil.getConnectDb();
	 ...
	 * @throws ClassNotFoundException 
	 */
	public BookBean get_BookInfo(int bid) throws ClassNotFoundException{
		BookBean tag = new BookBean();
		Connection conn = DBUtil.getConnectDb();
	 ...
	 * @throws ClassNotFoundException 
	 */
	public void updateBook(int bid, String card, String name, String type, String autho, String press, int num) throws ClassNotFoundException {
		// TODO Auto-generated method stub
		Connection conn = DBUtil.getConnectDb();
		String sql = "update book set name=?,card=?,type=?,autho=?,press=?,num=? where bid=?";
		System.out.println(bid+" "+card+" "+name);
	 ...
	 * @throws ClassNotFoundException 
	 */
	public void deleteBook(int bid) throws ClassNotFoundException {
		// TODO Auto-generated method stub
		Connection conn = DBUtil.getConnectDb();
	 ...
	 * @throws ClassNotFoundException 
	 */
	public ArrayList<BookBean> getLikeList(String name) throws ClassNotFoundException {
		// TODO Auto-generated method stub
		ArrayList<BookBean> tag_Array = new ArrayList<BookBean>();
		Connection conn = DBUtil.getConnectDb();
	 ...
	 * @throws ClassNotFoundException 
	 */
	public void borrowBook(int bid, AdminBean adminbean) throws ClassNotFoundException {
		// TODO Auto-generated method stub
	 ...
	 * @throws ClassNotFoundException 
	 */
	public void borrowBook2(int hid) throws ClassNotFoundException {
		// TODO Auto-generated method stub
		//生成日期
		Calendar c = Calendar.getInstance();
		int year = c.get(Calendar.YEAR);  
