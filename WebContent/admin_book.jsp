            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="collapse navbar-collapse main-navbar-collapse">
                        <a class="navbar-brand" href="admin.jsp"><strong>欢迎使用共享汽车管理系统</strong></a>
        ...
        <div class="row">
            ...
            <div class="col-md-2 bootstrap-admin-col-left">
                <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
                    <li>
                        <a href="admin_book.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 汽车管理</a>
                    </li>
                    <li>
                        <a href="admin_user.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 用户管理</a>
                    </li>
                    <li>
                        <a href="admin_booktype.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 汽车分类管理</a>
                    </li>
                    <li>
                        <a href="admin_borrow.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 汽车租借信息</a>
                    </li>
                    <li>
                        <a href="admin_history.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 汽车归还信息</a>
                    </li>
                </ul>
                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                ...
                                <input type="hidden" name="tip" value="1">
                        			<div class="col-lg-7 form-group">
                                        <label class="col-lg-4 control-label" for="query_bname">汽车名称</label>
                                        <div class="col-lg-8">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <button type="button" class="btn btn-primary" id="btn_add" data-toggle="modal" data-target="#addModal">添加汽车</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                               ...
                               <form class="form-horizontal" method="post" action="updateBookServlet">   <!--保证样式水平不混乱-->   
									<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
										...
										<div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">汽车号</label>
												<div class="col-sm-7">
												<input type="hidden" id="updateBookId" name="updatebid" id="updatebid" value="">
													<input type="text" class="form-control" id="updateISBN" name="card"  placeholder="请输入汽车号">
										 ...
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">汽车名称</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updateBookName" name="name"  placeholder="请输入汽车名称">
												<label class="control-label" for="updateBookName" style="display: none;"></label>
												</div>
										</div>
											
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">汽车类型</label>
											<div class="col-sm-7">
...
ArrayList<TypeBean> data = (ArrayList<TypeBean>)typedao.get_ListInfo();
  ...
  %>                 <option value="<%= bean.getName() %>"><%= bean.getName() %></option>                        <%} %>                                        
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">用户名称</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updateAutho" name="autho" placeholder="请输入用户名称">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">出租地</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updatePress" name="press"  placeholder="请输入出租地">
                                 ...
                                 <form class="form-horizontal" method="post" action="AddBookServlet">   <!--保证样式水平不混乱-->   
									...
									<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										...
										<div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">汽车号</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="addISBN" required="required" name="card" placeholder="请输入汽车号">
										 ...
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">汽车名称</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="addBookName" required="required" name="name"  placeholder="请输入汽车名称">
  ...
  %>                 <option value="<%= bean.getName() %>"><%= bean.getName() %></option>                        <%} %>
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">用户名称</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="addAutho" required="required" name="autho"  placeholder="请输入用户名称">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">出租地</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="addPress" required="required" name="press"  placeholder="请输入出租地">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">总数量</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="addNum" required="required" name="num" placeholder="请输入汽车总数量">
