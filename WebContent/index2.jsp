                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li role="presentation" class="divider"></li>
                                <li><a href="/books/login.html">退出</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">汽车查询</div>
                        </div>
                        <div class="bootstrap-admin-panel-content">
                            <ul>
                                <li>根据汽车编号、汽车名称查询汽车信息</li>
                                <li>可查询汽车的编号、名称、分类、出租地、价格、在数量等</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <!-- 判断用户是否登录 -->
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">租借信息</div>
                        </div>
                        <div class="bootstrap-admin-panel-content">
                            <ul>
                                <li>可查询除汽车的基本信息、租借日期、截止还车日期、超期天数等</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">租借历史</div>
                        </div>
                        <div class="bootstrap-admin-panel-content">
                            <ul>
                                <li>查询自己以往的租借历史，包括哪些租借等具体信息</li>
                            </ul>
                        </div>
                    </div>
                </div>
