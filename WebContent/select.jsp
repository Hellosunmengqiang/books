                            ...
                            <!---在此插入信息-->
                             ...
                             %>                 
								<tbody>
	                                ...
	                                <td><%= bean.getPress() %></td>  
	                                <td><%= bean.getNum() %></td>
<td><button type="button" class="btn btn-info btn-xs" data-toggle="modal" onclick="borrowbook(<%= bean.getBid() %>)" >出租</button>   	</td>   
 <form action="Carsxq" method="post">
        		     <input type="hidden" name="id" value="<%=bean.getBid()%>">  
        		       
   <td><button type="submit" class="btn btn-info btn-xs" data-toggle="modal" value="<%= bean.getBid()%>" name="bid">详情</button>   	</td>                                      
       </form>                                
                          	  </tbody>
                       <%} %> 
