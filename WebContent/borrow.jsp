        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="collapse navbar-collapse main-navbar-collapse">
                    <a class="navbar-brand" href="/reader.jsp"><strong>欢迎使用共享汽车管理系统</strong></a>
    ...
    <div class="row">
        ...
        <div class="col-md-2 bootstrap-admin-col-left">
            <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
               <li>
                    <a href="/books/select.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 汽车查询</a>
                </li>
	            <li>
	                 <a href="/books/borrow.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 租借信息</a>
	                </li>
	                <li>
	                    <a href="/books/history.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 租借历史</a>
	                </li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">当前租借信息</div>
                            </div>
                        ...
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            %>                 
                            	<tbody>
	                                ...
	                                <td>
<button type="button" class="btn btn-info btn-xs" data-toggle="modal" onclick="haibook(<%= bean.getHid() %>)">还车</button>
	                                </td>                                               
                          	  </tbody>
                             <%} %> 
                        </table>
									...
									<div class="modal fade" id="findBackModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										...
										<!---------------------表单-------------------->
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">租借编号</label>
												<div class="col-sm-7">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">租借汽车ISBN号</label>
											<div class="col-sm-7">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">租借汽车名称</label>
												<div class="col-sm-7">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">租借汽车类型</label>
												<div class="col-sm-7">
