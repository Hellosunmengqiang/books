            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="collapse navbar-collapse main-navbar-collapse">
                        <a class="navbar-brand" href="/admin/admin.jsp"><strong>欢迎使用共享汽车管理系统</strong></a>
        ...
        <div class="row">
            ...
            <div class="col-md-2 bootstrap-admin-col-left">
                <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
                    <li>
                        <a href="/books/admin_book.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 汽车管理</a>
                    </li>
                    <li>
                        <a href="/books/admin_user.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 用户管理</a>
                    </li>
                    <li>
                        <a href="/books/admin_booktype.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 汽车分类管理</a>
                    </li>
                    <li>
                        <a href="/books/admin_borrow.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 汽车租借信息</a>
                    </li>
                    <li>
                        <a href="/books/admin_history.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 汽车归还信息</a>
                    </li>
                </ul>
    		...
    		location.href = "/books/deleteUserServlet?aid="+aid;
                               ...
                               <form class="form-horizontal" method="post" action="/books/updateUserServlet">   <!--保证样式水平不混乱-->   
									<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">可租借天数</label>
												<div class="col-sm-7">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">最大租借数</label>
												<div class="col-sm-7">
                                 ...
                                 <form class="form-horizontal" method="post" action="/books/AddUserServlet">   <!--保证样式水平不混乱-->   
									...
									<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">可租借天数</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" name="lend_num" id="updatelend_num" required="required"  placeholder="请输入可租借天数">
